...
public class BetterHashDiff extends Diff {
	...
	public Association<Integer, String> diffHelper(int remainingFile1Index, int remainingFile2Index) {
		BetterIntPair pair = new BetterIntPair(remainingFile1Index, remainingFile2Index); // pair to check
		...
		if (equalAssoc != null && equalAssoc.getKey() < file1Cost && equalAssoc.getKey() < file2Assoc.getKey()) {
			BetterIntPair equalPair = new BetterIntPair(remainingFile1Index, remainingFile2Index);
	...
	protected Association<Integer, String> diffFormatHelper(int cost, int idx1, int idx2, int idx,
		...
		BetterIntPair pair = new BetterIntPair(idx1, idx2); // pair to add as key
